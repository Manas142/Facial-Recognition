...
def process_image(image_data):
    ...
    fs = GridFS(db, collection='allImages')  # Replace 'allImages' with the correct files collection name

    # Define the folder path where the images will be saved
    output_folder_path = r'C:\Users\admin\Desktop\chimzlab\all_images'
